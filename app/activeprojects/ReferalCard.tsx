...
//   return (
//     <div className="bg-white rounded-lg mb-4 shadow-sm relative border p-6">
//       <div className="flex justify-between p-4">
//         <div className="flex flex-col justify-center">
//           <h3 className="text-xl font-bold mb-2">Invite and earn $25.00</h3>
...
//                 className="w-[410px] border rounded-full py-3 px-4  border-purple-600"
//                 readOnly
//               />
