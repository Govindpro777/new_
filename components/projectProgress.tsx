...
const ProjectProgressTracker = () => {
  ...
  return (
    <div className="bg-[#f1efeb] max-w-6xl mx-auto py-8 px-4">
      ...
      <div className="mt-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">Annotated Bibliography</h1>
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-4 mt-4">Choose an expert for your project</h1>
      </div>
    </div>
  );
};
